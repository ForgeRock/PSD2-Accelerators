 ...
 * @since AM 5.5.0
 */
public class IdTokenHintNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(IdTokenHintNodePlugin.currentVersion,
                Collections.singletonList(IdTokenHintNode.class));
    }
    ...
    public String getPluginVersion() {
        return IdTokenHintNodePlugin.currentVersion;
    }
}