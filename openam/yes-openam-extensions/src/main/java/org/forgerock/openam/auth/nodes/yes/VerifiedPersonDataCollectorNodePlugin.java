 ...
 * @since AM 5.5.0
 */
public class VerifiedPersonDataCollectorNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(VerifiedPersonDataCollectorNodePlugin.currentVersion,
    ...
    public String getPluginVersion() {
        return VerifiedPersonDataCollectorNodePlugin.currentVersion;
    }
}
