...
# base uri of AM
openam_endpoint=https://login6.booleans.local:8443/xs
# client settings
...
curl_opts="-k"
# claims
claims='{"userinfo":{ "https://www.yes.com/claims/verified_person_data": { "claims": { "given_name":null,"family_name":null,"birthdate":null,"https://www.yes.com/claims/place_of_birth":null,"https://www.yes.com/claims/nationality":null,"address":null}}}}'
