...
/**
 * Starts a jetty instance with the application deployed.
 */
public final class EmbeddedServer {
	// this is only used when not defined in pom.xml
	...
	public static void main(String[] args) throws Exception {
		...
		ResourceConfig config = new ResourceConfig(RemoteConsentService.class);
