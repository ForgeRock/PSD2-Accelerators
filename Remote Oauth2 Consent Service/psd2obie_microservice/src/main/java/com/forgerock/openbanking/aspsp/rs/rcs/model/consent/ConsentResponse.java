...
public class ConsentResponse   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consentRequest, consentRequestFieldName, clientName, state, username, scopeList, accountList, claims, initiationClaims, obPaymentConsentPISP, flow, obAccountsAccessConsentAIPS);
  }
