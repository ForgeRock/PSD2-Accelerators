...
import com.forgerock.nextgenpsd2.aspsp.rs.rcs.model.consent.RequestConsntToIDM;
...
public class ConsentManagementTest {
	...
	String paymentIntentID="1a64f4e5-8b7f-430d-bf76-69b3a38f7ed5";
	String accountIntentID="b2f3ab6e-89d7-4f57-8e7e-157a880616eb";
	...
	public void getOBPaymentConsentTest() throws Exception {		
		...
		BGPaymentConsentResponse obPaymentConsentResponse = gson.fromJson(entity.getBody(), BGPaymentConsentResponse.class);
		...
		log.info("getOBPaymentConsentTest getAmount() {} ", obPaymentConsentResponse.getInstructedAmount().getAmount());
