 ...
 ***************************************************************************/
package com.forgerock.nextgenpsd2.aspsp.rs.rcs.web.rest.util;
...
import com.forgerock.nextgenpsd2.aspsp.rs.rcs.model.claims.Claim;
import com.forgerock.nextgenpsd2.aspsp.rs.rcs.model.claims.Claims;
import com.forgerock.nextgenpsd2.aspsp.rs.rcs.service.consent.ConsentManagementTest;
...
public class ParseJWTFromRequestTest {
	...
	@Test
	public void psd2AspsConsent() throws JsonParseException, JsonMappingException, IOException, ParseException {
		...
		//Claim instentId = claimsMap.getUserInfoClaims().get(BerlingGroupConstants.IdTokenClaim.INTENT_ID);
		...
		//assertTrue(claimsMap.getUserInfoClaims().containsKey(BerlingGroupConstants.IdTokenClaim.INTENT_ID) );
