 ...
 ***************************************************************************/
package com.forgerock.nextgenpsd2.aspsp.rs.rcs.service;
...
public class RcsService {
	 ...
	 * @throws Exception
	 */
	public String generateRCSConsentResponse(ApplicationProperties rcsConfiguration,
		...
		return jwtManagementService.senderSingEncripyJWT(requestParameterClaims.build(), amConfiguration);
	}
