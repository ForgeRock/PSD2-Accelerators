...
function constructPISPPolicyData(paymentIntentID, inputSub, inputPaymentInitiation){
	...
	policyData.description = "BG PISP Consent Policy - autogenerated by IDM";
	...
	console.log("AM BG PISP Policy Created: " + policyData.name);
...
function constructAISPPolicyData(accountInformationConsentID, inputSub, inputAispInitiation){
	...
	policyData.active = true;
	policyData.description = "BG AISP Consent Policy - autogenerated by IDM";
	...
	console.log("AM BG AISP Policy Created: " + policyData.name);
